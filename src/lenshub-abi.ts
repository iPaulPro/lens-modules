export const lensHubAbi = [{
    ...
    inputs: [{
        ...
        components: [{internalType: 'address', name: 'signer', type: 'address'}, {
            internalType: 'uint8',
            name: 'v',
            type: 'uint8'
    ...
    inputs: [{
        ...
        name: 'followTokenIds',
        type: 'uint256[]'
    }], name: 'batchMigrateFollowers', outputs: [], stateMutability: 'nonpayable', type: 'function'
}, {
    inputs: [{
        internalType: 'uint256',
        ...
        name: 'followTokenIds',
        type: 'uint256[]'
    }], name: 'batchMigrateFollows', outputs: [], stateMutability: 'nonpayable', type: 'function'
}, {
    inputs: [{internalType: 'uint256[]', name: 'profileIds', type: 'uint256[]'}],
    ...
    inputs: [{
        ...
        type: 'bool'
    }], name: 'changeDelegatedExecutorsConfig', outputs: [], stateMutability: 'nonpayable', type: 'function'
}, {
    inputs: [{
        internalType: 'uint256',
        name: 'delegatorProfileId',
    ...
    inputs: [{
        components: [{
            ...
            type: 'bytes'
        }], internalType: 'struct Types.CommentParams', name: 'commentParams', type: 'tuple'
    }],
    name: 'comment',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    stateMutability: 'nonpayable',
    ...
    inputs: [{
        ...
        name: 'transactionExecutor',
        type: 'address'
    }], name: 'emitUnfollowedEvent', outputs: [], stateMutability: 'nonpayable', type: 'function'
}, {
    inputs: [],
    name: 'emitVersion',
    outputs: [],
    ...
    outputs: [{
        components: [{
            ...
            name: 'rootPubId',
            type: 'uint256'
        }], internalType: 'struct Types.PublicationMemory', name: '', type: 'tuple'
    }],
    stateMutability: 'pure',
    type: 'function'
}, {
    ...
    inputs: [{internalType: 'uint256', name: 'followedProfileId', type: 'uint256'}, {
        internalType: 'address',
    ...
    inputs: [{internalType: 'uint256', name: 'followerProfileId', type: 'uint256'}, {
        internalType: 'uint256',
    ...
    inputs: [{
        components: [{
            ...
            name: 'referenceModuleData',
            type: 'bytes'
        }], internalType: 'struct Types.MirrorParams', name: 'mirrorParams', type: 'tuple'
    }],
    name: 'mirror',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    stateMutability: 'nonpayable',
    ...
    inputs: [{
        components: [{
            ...
            name: 'referenceModuleInitData',
            type: 'bytes'
        }], internalType: 'struct Types.QuoteParams', name: 'quoteParams', type: 'tuple'
    }],
    name: 'quote',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    stateMutability: 'nonpayable',
    ...
    inputs: [{internalType: 'uint256', name: 'byProfileId', type: 'uint256'}, {
        internalType: 'uint256[]',
    ...
    inputs: [{internalType: 'uint256', name: 'byProfileId', type: 'uint256'}, {
        ...
        components: [{
            ...
            name: 'deadline',
            type: 'uint256'
        }], internalType: 'struct Types.EIP712Signature', name: 'signature', type: 'tuple'
    }], name: 'setBlockStatusWithSig', outputs: [], stateMutability: 'nonpayable', type: 'function'
}, {
    ...
    inputs: [{internalType: 'uint256', name: 'profileId', type: 'uint256'}, {
        ...
        name: 'signature',
        type: 'tuple'
    }], name: 'setFollowModuleWithSig', outputs: [], stateMutability: 'nonpayable', type: 'function'
}, {
    ...
    inputs: [{internalType: 'address[]', name: 'migrationAdmins', type: 'address[]'}, {
        internalType: 'bool',
        name: 'whitelisted',
        type: 'bool'
    }], name: 'setMigrationAdmins', outputs: [], stateMutability: 'nonpayable', type: 'function'
}, {
    inputs: [{internalType: 'uint256', name: 'profileId', type: 'uint256'}, {
        internalType: 'string',
        name: 'metadataURI',
        type: 'string'
    }], name: 'setProfileMetadataURI', outputs: [], stateMutability: 'nonpayable', type: 'function'
}, {
    inputs: [{internalType: 'uint256', name: 'profileId', type: 'uint256'}, {
        internalType: 'string',
        name: 'metadataURI',
        ...
        name: 'signature',
        type: 'tuple'
    }], name: 'setProfileMetadataURIWithSig', outputs: [], stateMutability: 'nonpayable', type: 'function'
}, {
    ...
    inputs: [{
        ...
        name: 'signature',
        type: 'tuple'
    }], name: 'unfollowWithSig', outputs: [], stateMutability: 'nonpayable', type: 'function'
}, {
    inputs: [{internalType: 'address', name: 'profileCreator', type: 'address'}, {
        internalType: 'bool',
        name: 'whitelist',
        type: 'bool'
    }], name: 'whitelistProfileCreator', outputs: [], stateMutability: 'nonpayable', type: 'function'
}] as const;